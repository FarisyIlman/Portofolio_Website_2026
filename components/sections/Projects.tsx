            ...
            {filteredProjects.map((project: Project) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-slate-950/60 border border-white/10 backdrop-blur-md rounded-2xl flex flex-col justify-between group hover:border-cyan-500/40 hover:shadow-[0_0_25px_rgba(6,182,212,0.1)] transition-all duration-300 relative overflow-hidden"
                >
                  <a
                    href={targetUrl || '#'}
                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-center justify-between mb-6">
                        ...
                        <FolderKanban className="w-4 h-4 text-slate-600 group-hover:text-cyan-400 transition-colors" />
                      </div>

                      {/* Title Statement */}
                      <h3 className="text-xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors duration-300 flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-4 border-t border-white/5 pt-4">
                        {project.githubUrl && (
                          <span
                            ...
                            className="text-xs font-mono font-bold text-slate-400 hover:text-white flex items-center gap-1.5 transition-colors cursor-pointer z-10"
                          >
                        ...
                        {project.liveUrl && (
                          <span
                            ...
                            className="text-xs font-mono font-bold text-cyan-400 hover:text-cyan-300 flex items-center gap-1.5 transition-colors ml-auto cursor-pointer z-10"
                          >
                            <span>Live Run</span>
